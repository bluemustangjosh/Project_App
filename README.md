...
Calendar Integration — Visual calendar for tracking assignment due dates, exams, and class events at a glance.
Class Chat Rooms — Real-time chat rooms scoped to each class for discussion, questions, and group coordination.
